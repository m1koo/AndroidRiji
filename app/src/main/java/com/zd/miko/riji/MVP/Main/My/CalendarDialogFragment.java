...
public class CalendarDialogFragment extends DialogFragment {
    ...
    private MyBottomAdapter adapter = new MyBottomAdapter(mData);
    ...
    private void initClick() {
        ...
        adapter.setOnItemClick(new MyBottomAdapter.OnItemClick() {
            @Override
            ...
            @Override
            public void itemLongClick(int position, MyBottomAdapter.MyBottomVH holder) {
