...
class SharedArticleAdapter extends RecyclerView.Adapter<SharedArticleAdapter.MyVH> {
    ...
    public SharedArticleAdapter(ArrayList<ArticleWorldBean> mData) {
        this.mData = mData;
    }
    ...
    public void onBindViewHolder(MyVH holder, int position) {
        holder.itemView.setOnClickListener(v -> {
            if (listener != null) {
                listener.onClickListener(mData.get(position).getArticleId());
            } else {
                Log.i("xyz", "Item click监听为null");
            }
        });
