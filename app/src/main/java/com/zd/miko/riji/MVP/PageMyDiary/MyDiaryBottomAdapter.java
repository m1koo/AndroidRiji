...
public class MyDiaryBottomAdapter extends RecyclerView.Adapter<MyDiaryBottomAdapter.MyBottomVH> {

    public interface OnItemClick {
        void itemClick(int position);

        void itemLongClick(int position, MyDiaryBottomAdapter.MyBottomVH holder);
    }
    ...
    public MyDiaryBottomAdapter(ArrayList<DiaryBriefBean> mData) {
        this.mData = mData;
    }
