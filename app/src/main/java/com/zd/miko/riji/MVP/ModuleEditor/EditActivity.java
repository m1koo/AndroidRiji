    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_done:
                ...
                int height = richTextEditor.getHeight();

                int bottom = richTextEditor.getBottom();

                Log.i(TAG, "height: " + height + " bottom " + bottom);
                ...
                new Thread(() -> {
                    ...
                    Flowable.fromIterable(fileList)
                            ...
                            .subscribe(fileList1 -> {
                                ...
                                EventBus.getDefault().post(new MessageEvent(articleId, "PicZip"));
                            });
                }).start();
